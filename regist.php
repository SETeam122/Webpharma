...
<input type="Password"placeholder="Enter your password" id="passowrd" name="password" required><br>
<label>Confirm Password:</label><br>
<input type="Password" id="confirmpassword" name="confirmpassword" placeholder="Re-Type your password" required><br>
<label>Mobile Number:</label><br>
<input type="text"id="mobilenumber" name="mobilenumber" placeholder="Enter your mobilenumber" required><br>
<label>Age:</label><br>
...
<input type="radio" name="gender" id="male" value="male" required> <b>Male</b>
 <input type="radio" name="gender" id="female" value="female" required> <b>Female</b>
 <input type="radio" name="gender" id="others" value="other" required> <b>Others</b><br>
